...
const UFO_LOCAL: Record<string, LocalImage[]> = {
  roswell: [
    { source: require("../../../assets/ufo/roswell_1.jpg"), caption: "Marcel segurando fragmentos do balão encontrado em Roswell" },
  ...
  nimitz: [
     { source: require("../../../assets/ufo/nimitz_1.png"), caption: "Oceano Pacífico — local do avistamento do USS Nimitz" },
  ...
  wow: [
    ...
    { source: require("../../../assets/ufo/wow_2.png"), caption: "Representação artística de sinal de rádio interestelar" },
  ],
  rendlesham: [
